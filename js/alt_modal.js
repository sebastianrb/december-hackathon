(function() {
  ...
  //******** SBC proposal *********//
  // ******** move DOM query inside of transitionModal function *****//
  ...
  function transitionModal(e) {
    ...
    //******** SBC proposal *********//
    //**** grab all the student images here to make sure to get all current images that are loaded into the grid ****//
    //**** convert studentImageGridImages to an Array so we can use indexOf method and not have the break statment ***//
  ...
  modalExitButton.addEventListener('click', function _close(e) {
   ...
   // SCROLL TO POSITION OF CURRENT IMAGE ON GRID
    ...
    modalExitTransitionTimeline.add(function() {
      selectedStudentImagePosDim = selectedStudentImage.getBoundingClientRect();
    });
  ...
  function goToPrev() {
    ...
    modalNextProfileTransitionTimeline.add(function() { imgClone.remove();
      modalStudentProfileImage.src = selectedStudentImage.src; });
